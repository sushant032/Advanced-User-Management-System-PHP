...
class Student
{
  ...
  public function applyToInternship($fields){
    if(!$this->_db->insert('applied',$fields)){
        throw new Exception('There was a problem applying to the internship.');
    }
  }

  public function create($fields){
    if(!$this->_db->insert('users',$fields)){
        throw new Exception('There was a problem creating the student user account.');
    }
  }
