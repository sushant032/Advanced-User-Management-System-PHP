        ...
        <div class="row container-fluid">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">Your Internships</h3>
            </div>
            <div class="panel-body">
              <?php $internship = $company->getMyInternships();
                if(!count($internship)):
              ?>
              <h2>Sorry you haven't posted any internships yet.</h2>
            <?php else:
              echo "<h2>You have posted ".count($internship)." internships.</h2><br><br>";
              echo '<table class="table table-hover">
                ...
                echo "<tr>
                  <td>{$in->start_date}</td>
                  <td>{$in->duration} months</td>
                  <td>{$in->stipend}/month</td>
                  <td>{$in->created_at}</td>
                  <td>{$in->apply_by}</td>
                  <td><a href='view-applications.php?id=".$in->id."' class='btn btn-success'>View Applications</a></td>
                  </tr>";
            ...
            <?php endif; ?>
              <a href="newinternship.php" class="btn btn-primary" style="margin-top:30px;">Create new internship</a>
            </div>
          </div>
          </div>
        </div>
